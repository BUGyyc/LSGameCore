...
namespace Server.LiteNetLib
{
    public class LiteNetLibServer : IServer
    {
        ...
        public LiteNetLibServer()
        {
            ...
            _server = new NetManager(_listener) { DisconnectTimeout = 30000 };
        }
        ...
        {
            _server.ConnectedPeerList
                .First(peer => peer.Id == clientId)
                .Send(data, DeliveryMethod.ReliableOrdered);
        }
        ...
        public void Run(int port)
        {
            ...
            {
                //确认链接
                request.AcceptIfKey(NetSetting.NetConnectKey);
            };
