...
{
    [BuildInNode(
        typeof(BTActionPrioritizedSelector),
        EBTBuildInTypeIdx.BTActionPrioritizedSelector
    )]
    public unsafe partial class BTActionPrioritizedSelector : BTComposite
    {
        ...
        {
            return new object[] { *(BTCActionPrioritizedSelector*)wData.GetContext(_uniqueKey), };
        }
        ...
        protected override bool OnEvaluate( /*in*/
            BTWorkingData wData
        )
        {
