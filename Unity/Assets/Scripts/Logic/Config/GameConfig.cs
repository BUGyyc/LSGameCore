...
namespace Lockstep.Game
{
    ...
    [Serializable]
    public class BallConfig : EntityConfig
    {
        public override object Entity => entity;
        public Ball entity = new Ball();
    }
    ...
    public class CollisionConfig
    {
        ...
        public bool[] collisionMatrix = new bool[
            (int)EColliderLayer.EnumCount * (int)EColliderLayer.EnumCount
        ];
    ...
    public class GameConfig : ScriptableObject
    {
        ...
        public List<BallConfig> ball = new List<BallConfig>();
        ...
        private T GetConfig<T>(List<T> lst, int id)
        ...
        public BallConfig GetBallConfig(int id)
        {
            return GetConfig(ball, id);
        }
